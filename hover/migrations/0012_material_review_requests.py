...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="hover_source_participant_bindings",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "state",
                    models.TextField(
                        choices=[("needs_review", "Needs review"), ("resolved", "Resolved")],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="conflicting_evidence",
                        to="hover.disputeddetail",
                    ),
                ),
                (
                    "evidence_link",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "state",
                    models.TextField(
                        choices=[("open", "Open"), ("resolved", "Resolved")], default="open"
                    ),
                ),
                ("date_created", models.DateTimeField(default=django.utils.timezone.now)),
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.RESTRICT,
                        related_name="hover_review_request",
                        to="zerver.message",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        choices=[
                            ("involved_teammate", "Involved teammate"),
                            ("space_admin_fallback", "Space administrator fallback"),
                        ]
                    ),
                ),
                ("date_created", models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.AddConstraint(
            model_name="sourceparticipantbinding",
            constraint=models.UniqueConstraint(
                fields=("source", "participant_ref"), name="hover_source_participant_unique_ref"
            ),
        ),
        migrations.AddConstraint(
            model_name="disputeddetail",
            constraint=models.UniqueConstraint(
        ...
        migrations.AddConstraint(
            model_name="disputeddetail",
            constraint=models.UniqueConstraint(
                fields=("generated_item", "field_path"), name="hover_disputed_detail_unique_field"
            ),
        ),
        migrations.AddConstraint(
            model_name="disputeddetail",
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(("resolved_by_revision__isnull", True), ("state", "needs_review")),
                    models.Q(("resolved_by_revision__isnull", False), ("state", "resolved")),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            model_name="disputedevidencelink",
            constraint=models.UniqueConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(
                        ...
                        ("resolved_by_revision__isnull", True),
                        ("state", "open"),
                    ),
                    models.Q(
        ...
        migrations.AddConstraint(
            model_name="reviewrequesttarget",
            constraint=models.UniqueConstraint(
                fields=("review_request", "user"), name="hover_review_request_unique_target"
            ),
        ),
    ]
