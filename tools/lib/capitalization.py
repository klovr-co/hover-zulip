...
IGNORED_PHRASES = [
    ...
    r"YouTube",
    r"Zoom",
    # Hover product-domain proper nouns
    r"Hover",
    r"Space",
    r"Spaces",
    r"Source",
    ...
    r"Space Admin",
    r"ISO",
    # Hover UI fragments and a connected-account selector example
    r"revision\(s\)",
    r"to Hover update",
    r"whatsapp_group \| src_0123456789abcdef0123456789abcdef \| Leadership group",
    r"Last changed by \{\{latest_event.actor.full_name\}\} at \{\{latest_event.occurred_at\}\}",
    r"View sources \(\{\{generated_item.evidence_count\}\}\)",
    r"Zulip",
    r"Zulip Server",
    ...
    r"example\.com",
    r"acme",
    r"\{\{generated_item\.evidence_count\}\}",
    r"\{\{latest_event\.actor\.full_name\}\}",
    r"\{\{latest_event\.occurred_at\}\}",
