...
export const built_in_views_meta_data: Record<string, BuiltInViewBasicMetadata> = {
    ...
    hover_pipelines: {
        fragment: "hover/pipelines",
        name: $t({defaultMessage: "Pipelines"}),
        is_pinned: true,
        icon: "zulip-icon-git-pull-request",
        css_class_suffix: "pipelines",
        tooltip_template_id: "pipelines-tooltip-template",
        has_unread_count: false,
        unread_count_type: "",
        supports_masked_unread: false,
        hidden_for_spectators: true,
    ...
    hover_data_sources: {
        fragment: "hover/data-sources",
        name: $t({defaultMessage: "Data Sources"}),
        is_pinned: true,
        icon: "zulip-icon-bot",
        css_class_suffix: "data_sources",
        tooltip_template_id: "data-sources-tooltip-template",
        has_unread_count: false,
        unread_count_type: "",
        supports_masked_unread: false,
        hidden_for_spectators: true,
