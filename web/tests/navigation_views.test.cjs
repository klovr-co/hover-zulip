...
run_test("get_built_in_views", () => {
    ...
    assert.equal(inbox_view.cf_icon, "inbox");
    assert.equal(inbox_view.href, "#inbox");
    assert.match(inbox_view.item_classes, /top_left_inbox top_left_row/);
    assert.match(inbox_view.item_classes, /selected-home-view/);
    assert.match(inbox_view.action_classes, /sidebar-menu-icon inbox-sidebar-menu-icon/);
...
run_test("set_hover_enabled", () => {
    ...
    assert.equal(built_in_views_meta_data.hover_editions.cf_icon, "sun");
    ...
    assert.equal(built_in_views_meta_data.mentions.name, "translated: Mentions");
    assert.equal(built_in_views_meta_data.mentions.cf_icon, "at-sign");
    assert.ok(
