...
class AuditLogEventType(IntEnum):
    ...
    HOVER_CONNECTED_ACCOUNT_CREATED = 920
    HOVER_CONNECTED_ACCOUNT_APPROVAL_CHANGED = 921
    HOVER_CONNECTED_ACCOUNT_HEALTH_CHANGED = 922
    HOVER_CONNECTED_ACCOUNT_GRANT_CHANGED = 923
    HOVER_CONNECTED_ACCOUNT_GRANT_REVOKED = 924
    HOVER_SOURCE_ATTACHED = 925
    HOVER_SOURCE_DETACHED = 926
    HOVER_SOURCE_EVIDENCE_DELETED = 927
    HOVER_SPACE_MEMBERSHIP_ADDED = 928
    HOVER_SPACE_MEMBERSHIP_REMOVED = 929
    HOVER_PIPELINE_CREATOR_GRANTED = 930
    HOVER_PIPELINE_CREATOR_REVOKED = 931
    HOVER_MODULE_DRAFT_CREATED = 932
    HOVER_MODULE_DRAFT_UPDATED = 933
    HOVER_MODULE_DRAFT_COLLABORATOR_CHANGED = 934
    HOVER_MODULE_VERSION_PUBLISHED = 935
    HOVER_MODULE_DEFINITION_ARCHIVED = 936
    HOVER_MODULE_VERSION_ARCHIVED = 937
    HOVER_CONNECTED_ACCOUNT_LINK_CHANGED = 938
