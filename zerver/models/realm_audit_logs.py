...
class AuditLogEventType(IntEnum):
    ...
    HOVER_SPACE_DOCUMENT_CREATED = 930
    HOVER_SPACE_DOCUMENT_ARCHIVED = 931
    HOVER_SPACE_DOCUMENT_RESTORED = 932
    HOVER_DOCUMENT_CHECKPOINT_CREATED = 933
    HOVER_DOCUMENT_CHECKPOINT_RESTORED = 934
