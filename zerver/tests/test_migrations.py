...
class FixDeletedUserEmail(MigrationsTestCase):
    ...
    def setUpBeforeMigration(self, apps: StateApps) -> None:
        ...
        deleted_user = UserProfile.objects.get(delivery_email=self.example_email("hamlet"))
        ...
        control_user = UserProfile.objects.get(delivery_email=self.example_email("cordelia"))
        ...
        deactivated_user = UserProfile.objects.get(delivery_email=self.example_email("othello"))
