...
v1_api_and_json_patterns = [
    ...
    rest_path(
        "hover/pipeline-library",
        GET=(get_pipeline_library, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/creators",
        POST=(grant_pipeline_creator, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/creators/<int:user_id>",
        DELETE=(revoke_pipeline_creator, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/drafts",
        POST=(create_module_draft, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/drafts/<int:draft_id>",
        PATCH=(update_module_draft, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/drafts/<int:draft_id>/collaborators",
        POST=(add_module_draft_collaborator, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/drafts/<int:draft_id>/collaborators/<int:user_id>",
        DELETE=(remove_module_draft_collaborator, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/drafts/<int:draft_id>/publish",
        POST=(publish_module_draft, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/versions/<int:version_id>/successor",
        POST=(create_successor_module_draft, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/definitions/<int:definition_id>/archive",
        POST=(archive_module_definition, {"intentionally_undocumented"}),
    ),
    rest_path(
        "hover/pipeline-library/versions/<int:version_id>/archive",
        POST=(archive_module_version, {"intentionally_undocumented"}),
    ),
    rest_path(
